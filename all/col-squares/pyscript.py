...
if os.path.exists(localfile("col-squares","config.yaml")):
    with open(localfile("col-squares","config.yaml"),"r") as f:
            ...
            if e.button == 2:
                ...
                if rainbow:
                    ...
                    if tocolour == len(colours[0]):
                        tocolour = 1
                        rainbow = True
            with open(localfile("col-squares","config.yaml"),"w+") as f:
